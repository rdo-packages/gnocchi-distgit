...
Obsoletes:      openstack-%{service}-api < 4.1.2-0.20171222000340
...
Obsoletes:        openstack-%{service}-common < 4.1.2-0.20171222000340
...
Obsoletes:        openstack-%{service}-indexer-sqlalchemy < 4.1.2-0.20171222000340
...
Obsoletes:      openstack-%{service}-metricd < 4.1.2-0.20171222000340
...
Obsoletes:      openstack-%{service}-statsd < 4.1.2-0.20171222000340
...
Obsoletes:        openstack-%{service}-doc < 4.1.2-0.20171222000340
