...
Obsoletes:      openstack-%{service}-api < %{version}-%{release}
...
Obsoletes:        openstack-%{service}-common < %{version}-%{release}
...
Obsoletes:        openstack-%{service}-indexer-sqlalchemy < %{epoch}:%{version}-%{release}
...
Obsoletes:      openstack-%{service}-metricd < %{version}-%{release}
...
Obsoletes:      openstack-%{service}-statsd < %{version}-%{release}
